...
/* USER CODE BEGIN PV */
uint16_t ID=0;
extern const unsigned short foto4[76800];
//extern const unsigned short taca[66880];
/* USER CODE END PV */
...
int main(void)
{
  ...
  //printnewtstr(100, RED, &mono12x7bold, 1, "HELLO WOLRD");


  drawRGBBitmap(0, 59, foto4, 320, 60);
